...
public partial class SpaceContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Asteroids>(entity =>
        {
            ...
            entity.HasIndex(e => e.AstName, "UQ__Asteroids_ast_name").IsUnique();
            ...
            entity.HasOne(d => d.Star).WithMany(p => p.Asteroids)
        ...
        modelBuilder.Entity<BlackHoles>(entity =>
        {
            ...
            entity.HasIndex(e => e.BlackholeName, "UQ__BlackHoles_blackhole_name").IsUnique();
            ...
            entity.HasOne(d => d.Cons).WithMany(p => p.BlackHoles)
                .HasForeignKey(d => d.ConsId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_BlackHoles_To_Constellations");

            entity.HasOne(d => d.Glx).WithMany(p => p.BlackHoles)
        ...
        modelBuilder.Entity<Comets>(entity =>
        {
            ...
            entity.HasIndex(e => e.CometName, "UQ__Comets__comet_name").IsUnique();
            ...
            entity.HasOne(d => d.Star).WithMany(p => p.Comets)
                .HasForeignKey(d => d.StarId)
        ...
        modelBuilder.Entity<Constellations>(entity =>
        {
            ...
            entity.HasIndex(e => e.ConsAbbreviation, "UQ_Constellations_cons_abbreviation").IsUnique();

            entity.HasIndex(e => e.ConsName, "UQ_Constellations_cons_name").IsUnique();

            entity.HasIndex(e => e.ConsSymbolism, "UQ_Constellations_cons_symbolism").IsUnique();
        ...
        {
            entity.HasKey(e => e.GlxId).HasName("PK__Galaxies");

            entity.HasIndex(e => e.GlxName, "UQ_Galaxies_glx_name").IsUnique();
            ...
            entity.HasOne(d => d.Cons).WithMany(p => p.Galaxies)
                .HasForeignKey(d => d.ConsId)
                .HasConstraintName("FK_Galaxies_To_Constellations");

            entity.HasOne(d => d.Glxcluster).WithMany(p => p.Galaxies)
                .HasForeignKey(d => d.GlxclusterId)
                .HasConstraintName("FK_Galaxies_To_GalaxyClusters");

            entity.HasOne(d => d.Glxgroup).WithMany(p => p.Galaxies)
        ...
        modelBuilder.Entity<GalaxyClusters>(entity =>
        {
            ...
            entity.HasIndex(e => e.GlxclusterName, "UQ_GalaxyClusters_glxcluster_name").IsUnique();
            ...
            entity.HasOne(d => d.Cons).WithMany(p => p.GalaxyClusters)
                .HasForeignKey(d => d.ConsId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<GalaxyGroups>(entity =>
        {
            ...
            entity.HasIndex(e => e.GlxgroupName, "UQ_GalaxyGroups_glxgroup_name").IsUnique();
            ...
            entity.HasOne(d => d.Cons).WithMany(p => p.GalaxyGroups)
                .HasForeignKey(d => d.ConsId)
        ...
        {
            entity.HasKey(e => e.NebulaId).HasName("PK__Nebulae");

            entity.HasIndex(e => e.NebulaName, "UQ_Nebulae_nebula_name").IsUnique();
            ...
            entity.HasOne(d => d.Cons).WithMany(p => p.Nebulae)
                .HasForeignKey(d => d.ConsId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Nebulae_To_Constellations");

            entity.HasOne(d => d.Glx).WithMany(p => p.Nebulae)
                .HasForeignKey(d => d.GlxId)
        ...
        modelBuilder.Entity<PlanetarySystems>(entity =>
        {
            ...
            entity.HasIndex(e => e.PlanetsystemName, "UQ_PlanetarySystems_planetsystem_name").IsUnique();
            ...
            entity.HasOne(d => d.Cons).WithMany(p => p.PlanetarySystems)
                .HasForeignKey(d => d.ConsId)
                .HasConstraintName("FK_PlanetarySystems_To_Constellations");

            entity.HasOne(d => d.Glx).WithMany(p => p.PlanetarySystems)
                .HasForeignKey(d => d.GlxId)
        ...
        modelBuilder.Entity<Planets>(entity =>
        {
            ...
            entity.HasIndex(e => e.PlntName, "UQ_Planets_exo_name").IsUnique();
            ...
            entity.HasOne(d => d.Cons).WithMany(p => p.Planets)
                .HasForeignKey(d => d.ConsId)
        ...
        modelBuilder.Entity<StarClusters>(entity =>
        {
            ...
            entity.HasIndex(e => e.StarclusterName, "UQ_StarClusters_starcluster_name").IsUnique();
            ...
            entity.HasOne(d => d.Cons).WithMany(p => p.StarClusters)
                .HasForeignKey(d => d.ConsId)
                .HasConstraintName("FK_StarClusters_To_Constellations");

            entity.HasOne(d => d.Glx).WithMany(p => p.StarClusters)
                .HasForeignKey(d => d.GlxId)
        ...
        modelBuilder.Entity<Stars>(entity =>
        {
            ...
            entity.HasIndex(e => e.StarName, "UQ_Stars_star_name").IsUnique();
            ...
            entity.HasOne(d => d.Cons).WithMany(p => p.Stars)
                .HasForeignKey(d => d.ConsId)
                .HasConstraintName("FK_Stars_Constellations");

            entity.HasOne(d => d.Glx).WithMany(p => p.Stars)
                .HasForeignKey(d => d.GlxId)
                .HasConstraintName("FK_Stars_To_Galaxies");

            entity.HasOne(d => d.Planetsystem).WithMany(p => p.Stars)
                .HasForeignKey(d => d.PlanetsystemId)
                .HasConstraintName("FK_Stars_To_PlanetarySystems");

            entity.HasOne(d => d.Starcluster).WithMany(p => p.Stars)
